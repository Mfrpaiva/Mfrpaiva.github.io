...
# Biography Section
 ...
 # Experience Timeline
  ...
  <strong style="color: #4a9fd8;">“From a moment available, a useful force”</strong>
                  </a>
(Brazilian Catalysis Society – SBCat, 2020), as well as educational research on student retention and dropout in chemistry programs. Further details can be found in the <strong style="color: #4a9fd8;">Projects section</strong>.
            </div>
          </div>
    design:
      background:
