...
# Biography Section
  - block: markdown
    ...
    content:
      ...
      text: |
          <div style="column-count: 2; column-gap: 4rem; text-align: justify; width: 100%;">
          ...
          <div style="margin-top: 2rem; text-align: center;">
            <img src="/V2.png" alt="Biography image" style="max-width: 100%; height: auto; border-radius: 8px;">
          </div>
    design:
      columns: '2'
      background:
